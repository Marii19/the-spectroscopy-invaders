...
export default class bisimulationThree extends level{

    constructor(){
        let instructions: string[] = ['bisimulation', 'move conjunct info', "move negation info", 'move observation info']
        super('bisimulation three', 'a.(a.b.0+a.c.0)', 'a.(a.b.0+a.(b.0+c.0)+a.c.0)', 'Bisimulation', instructions);
    ...
    create(){
        ...
        let field_defender: Field =this.createField(600, 200, 'a.(a.b.0+a.(b.0+c.0)+a.c.0)', 6);

        this.createField(600, 320, 'a.b.0+a.(b.0+c.0)+a.c.0', 7);

        this.createField(500, 440, 'b.0', 8);

        this.createField(600, 440, 'b.0+c.0', 9);

        this.createField(700, 440, 'c.0', 10);
        ...
        this.add.image(550,380, 'arrow').rotation += 2.3;
        this.add.image(600,380, 'arrow').rotation += 1.57;
        this.add.image(650,380, 'arrow').rotation += 0.9;
        this.add.image(500,500, 'arrow').setTint(0xff0000).rotation += 1.57;
        this.add.image(550,500, 'arrow').setTint(0xFF0000).rotation += 2.3;
        this.add.image(650,500, 'arrow').setTint(0xFFAA00).rotation += 0.9;
        this.add.image(700,500, 'arrow').setTint(0xFFAA00).rotation += 1.575;
        ...
        this.observations[8][11] = 'b';
        this.observations[9][11] = 'b';
